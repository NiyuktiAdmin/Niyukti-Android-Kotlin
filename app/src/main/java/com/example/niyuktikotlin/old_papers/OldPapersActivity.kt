package com.example.niyuktikotlin.old_papers
...
class OldPapersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.old_papers_activity_rv)
        backBtn = findViewById(R.id.old_papers_activity_back_btn)
